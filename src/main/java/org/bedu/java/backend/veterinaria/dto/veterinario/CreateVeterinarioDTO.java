...
public class CreateVeterinarioDTO {
    ...
    @Schema(description = "Número de celular del veterinario", example = "+528331593654")
    @NotBlank(message = "El número de celular del veterinario es obligatorio")
    ...
    @NotBlank(message = "El correo electrónico del veterinario es obligatorio")
