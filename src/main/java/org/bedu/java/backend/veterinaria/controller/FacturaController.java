...
public class FacturaController {
    ...
    public void update(@PathVariable(name = "facturaId") Long facturaId, @RequestBody UpdateFacturaDTO data) throws FacturaNotFoundException {
    ...
    public void addMedicamento(@PathVariable Long facturaId,
        ...
        facturaMedicamentoService.addMedicamento(facturaId, data.getMedicamentoId(), data.getPrecio(), data.getCantidad());
    }
